...
func (x *CreteOrderResponse) Reset() {
	*x = CreteOrderResponse{}
	mi := &file_orders_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreteOrderResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreteOrderResponse) ProtoMessage() {}

func (x *CreteOrderResponse) ProtoReflect() protoreflect.Message {
	mi := &file_orders_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreteOrderResponse.ProtoReflect.Descriptor instead.
func (*CreteOrderResponse) Descriptor() ([]byte, []int) {
	return file_orders_proto_rawDescGZIP(), []int{2}
}

func (x *CreteOrderResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_orders_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x06.OrderR\x06orders2G\n" +
	"\fOrderService\x127\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x13.CreteOrderResponseB\"Z github.com/SovetkanB/Simple-gRPCb\x06proto3"
...
var file_orders_proto_goTypes = []any{
	...
	(*CreteOrderResponse)(nil), // 2: CreteOrderResponse
...
var file_orders_proto_depIdxs = []int32{
	...
	2, // 2: OrderService.CreateOrder:output_type -> CreteOrderResponse
